Shader "Differences/UI Hint Spotlight"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float2 position = input.uv * _Size;
                float a = smoothstep(_HoleA.z - _HoleA.w, _HoleA.z, distance(position, _HoleA.xy));
                float b = smoothstep(_HoleB.z - _HoleB.w, _HoleB.z, distance(position, _HoleB.xy));
