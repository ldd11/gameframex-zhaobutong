...
#if !UNITY_EDITOR
                // Local startup uses the resources bundled in the player; no patch server URL was requested.
                if (startupOptions.SkipRemoteStartupRequests && startupOptions.GamePlayMode == YooAsset.EPlayMode.EditorSimulateMode)
                    startupOptions.GamePlayMode = YooAsset.EPlayMode.OfflinePlayMode;
#endif
#if ENABLE_UI_UGUI
